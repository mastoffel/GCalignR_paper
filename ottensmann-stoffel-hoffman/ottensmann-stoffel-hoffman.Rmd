...
An easy workflow for the analysis of chemical data including `GCalignR` is shown in figure \ref{figure:workflow} and described below. The package vignette provides a detailed description of all functions and their arguments and can be assessed via \code{browseVignettes('GCalignR')} once the package was installed.
...
```{r,fig.align='center',fig.cap="A NMDS plot shows the similarity of individuals within colonies",fig.width=5,fig.height=5}
...
```
We aim to extend the functionalities of \pkg{GCalignR} in future and the developmental version can be downloaded from GitHub within R using \href{https://cran.r-project.org/web/packages/devtools/index.html}{\CRANpkg{devtools}} \citep{Oksanen.2016}
