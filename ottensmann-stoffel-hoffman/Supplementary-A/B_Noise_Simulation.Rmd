...
## Rational
Based on the original datasets on bumblebee species published by [@Dellicour.2013] we simulated different noise levels by adding small deviations to randomly selected peaks within each sample. Thereby we use the original data as a unbiased baseline to evaluate the robustness in peak alignments with GCalignR.
