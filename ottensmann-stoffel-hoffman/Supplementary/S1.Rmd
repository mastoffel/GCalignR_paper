...
This document provides the code for the validation of alignments presented in our paper. Some parts a computational demanding and run for several hours on a standard computer. Therefore, we provide the final dataset along with this documentation.  
